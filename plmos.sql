...
MySQL - 10.1.9-MariaDB : Database - plmos
*********************************************************************
*/
...
CREATE TABLE `bidding` (
  ...
  `BidCode` VARCHAR(20) DEFAULT NULL,
  `Description` TEXT,
...
INSERT  INTO `bidding`(`ID`,`BidCode`,`Description`,`StartBidPrice`,`BidPrice`,`StartDate`,`EndDate`,`CreatedDate`,`ModifiedDate`) VALUES (1,'LEGBID-20171221250','Today bid',1.00,0.01,'2016-02-21 00:00:00','2017-02-24 00:00:00','2017-02-22 12:50:55','2017-02-22 12:50:55'),(2,'LEGBID-20171241111','test123',10.00,10.00,'2017-02-23 00:00:00','2017-02-27 12:05:00','2017-02-24 11:11:53','2017-02-24 11:11:53');
...
INSERT  INTO `biddingbyusers`(`ID`,`BidItemID`,`CustomerNo`,`CreatedDate`) VALUES (1,1,27,'2017-02-22 22:28:54'),(2,1,28,'2017-02-22 22:30:57'),(3,2,27,'2017-02-22 22:37:41'),(9,2,37,'2017-02-23 22:59:25'),(10,1,37,'2017-02-23 22:59:29'),(11,3,37,'2017-02-23 22:59:38'),(12,4,37,'2017-02-23 22:59:40'),(13,1,37,'2017-02-23 23:04:10'),(14,1,28,'2017-02-23 23:21:08'),(15,2,28,'2017-02-23 23:21:12'),(16,2,37,'2017-02-23 23:21:15'),(17,1,37,'2017-02-23 23:21:22'),(18,1,37,'2017-02-23 23:38:01'),(19,2,37,'2017-02-23 23:38:06'),(20,3,37,'2017-02-23 23:38:11'),(21,4,37,'2017-02-23 23:38:13'),(22,4,37,'2017-02-23 23:38:14'),(23,4,37,'2017-02-23 23:38:15'),(24,4,37,'2017-02-23 23:38:17'),(25,4,37,'2017-02-23 23:38:18'),(26,4,37,'2017-02-23 23:38:20'),(27,4,37,'2017-02-23 23:38:21'),(28,4,37,'2017-02-23 23:38:23'),(29,4,37,'2017-02-23 23:38:24'),(30,1,37,'2017-02-23 23:42:38'),(31,1,37,'2017-02-23 23:42:53'),(32,1,37,'2017-02-23 23:43:20'),(33,2,37,'2017-02-23 23:43:20'),(34,3,37,'2017-02-23 23:43:21'),(35,3,37,'2017-02-23 23:43:22'),(36,4,37,'2017-02-23 23:43:23'),(37,2,37,'2017-02-23 23:43:25'),(38,1,37,'2017-02-23 23:43:26'),(39,2,37,'2017-02-23 23:43:27'),(40,2,37,'2017-02-23 23:43:29'),(41,1,37,'2017-02-23 23:43:31'),(42,2,37,'2017-02-23 23:43:33'),(43,2,37,'2017-02-23 23:43:34'),(44,5,37,'2017-02-24 11:48:18'),(45,5,37,'2017-02-24 12:03:33'),(46,5,28,'2017-02-24 12:11:18'),(47,5,37,'2017-02-24 12:11:22'),(48,5,28,'2017-02-24 12:12:05'),(49,5,37,'2017-02-24 12:13:04'),(50,5,28,'2017-02-24 12:13:06'),(51,5,28,'2017-02-24 12:13:19'),(52,5,37,'2017-02-24 12:13:21'),(53,5,37,'2017-02-24 12:13:25'),(54,5,28,'2017-02-24 12:13:30'),(55,5,28,'2017-02-24 12:14:25'),(56,5,37,'2017-02-24 12:14:28'),(57,5,28,'2017-02-24 12:14:53'),(58,5,37,'2017-02-24 12:14:58'),(59,5,37,'2017-02-24 12:16:16'),(60,5,37,'2017-02-24 12:16:39'),(61,5,37,'2017-02-24 12:16:43'),(62,5,28,'2017-02-24 12:16:51'),(63,5,28,'2017-02-24 12:16:55'),(64,5,28,'2017-02-24 12:16:58'),(65,5,28,'2017-02-24 12:17:06'),(66,5,37,'2017-02-24 12:17:11'),(67,5,28,'2017-02-24 12:17:14'),(68,5,37,'2017-02-24 16:07:33');
...
CREATE TABLE `biddingitems` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `BidCode` VARCHAR(20) DEFAULT NULL,
  `ItemNumber` INT(4) UNSIGNED ZEROFILL DEFAULT NULL,
...
INSERT  INTO `biddingitems`(`ID`,`BidCode`,`ItemNumber`,`VariantNo`) VALUES (1,'LEGBID-20171221250',0001,1),(2,'LEGBID-20171221250',0001,2),(3,'LEGBID-20171221250',0001,3),(4,'LEGBID-20171221250',0002,4),(5,'LEGBID-20171241111',0001,2);
...
/*Table structure for table `vw_biditems` */

DROP TABLE IF EXISTS `vw_biditems`;

/*!50001 DROP VIEW IF EXISTS `vw_biditems` */;
/*!50001 DROP TABLE IF EXISTS `vw_biditems` */;

/*!50001 CREATE TABLE  `vw_biditems`(
 `BidCode` varchar(20) ,
 `ID` int(11) ,
 `LastBidUser` varchar(32) ,
 `StartDate` datetime ,
 `EndDate` datetime ,
 `BidPrice` double(10,2) ,
 `StartBidPrice` double(10,2) ,
 `CurrentBidPrice` double(19,2) ,
...
/*Table structure for table `vw_biduserscount` */

DROP TABLE IF EXISTS `vw_biduserscount`;

/*!50001 DROP VIEW IF EXISTS `vw_biduserscount` */;
/*!50001 DROP TABLE IF EXISTS `vw_biduserscount` */;

/*!50001 CREATE TABLE  `vw_biduserscount`(
 `BidItemID` int(11) ,
 `LastBidUser` varchar(32) ,
 `NoOfBidUsers` bigint(21) ,
 `BidDate` datetime ,
 `CurrentBidPrice` double(19,2) ,
 `BidStatus` varchar(8) 
)*/;
...
/*Table structure for table `vw_lastbiduser` */

DROP TABLE IF EXISTS `vw_lastbiduser`;

/*!50001 DROP VIEW IF EXISTS `vw_lastbiduser` */;
/*!50001 DROP TABLE IF EXISTS `vw_lastbiduser` */;

/*!50001 CREATE TABLE  `vw_lastbiduser`(
 `ID` int(11) ,
 `BidItemID` int(11) ,
 `CustomerNo` int(11) ,
...
/*Table structure for table `vw_lastbidusers` */

DROP TABLE IF EXISTS `vw_lastbidusers`;

/*!50001 DROP VIEW IF EXISTS `vw_lastbidusers` */;
/*!50001 DROP TABLE IF EXISTS `vw_lastbidusers` */;

/*!50001 CREATE TABLE  `vw_lastbidusers`(
 `ID` int(11) ,
 `BidItemID` int(11) ,
 `CustomerNo` int(11) ,
 `CreatedDate` datetime 
...
/*View structure for view vw_biditems */

/*!50001 DROP TABLE IF EXISTS `vw_biditems` */;
/*!50001 DROP VIEW IF EXISTS `vw_biditems` */;

/*!50001 CREATE  VIEW `vw_biditems` AS (select `bi`.`BidCode` AS `BidCode`,`bi`.`ID` AS `ID`,ifnull(`bu`.`LastBidUser`,'-') AS `LastBidUser`,`b`.`StartDate` AS `StartDate`,`b`.`EndDate` AS `EndDate`,`b`.`BidPrice` AS `BidPrice`,`b`.`StartBidPrice` AS `StartBidPrice`,(`b`.`StartBidPrice` + (`b`.`BidPrice` * ifnull(`bu`.`NoOfBidUsers`,0))) AS `CurrentBidPrice`,concat(`iv`.`ItemNo`,'-',`iv`.`VariantNo`) AS `ItemNumber`,`i`.`Name` AS `Name`,`iv`.`VariantName` AS `VariantName`,ifnull(`iv`.`Stocks`,0) AS `Stocks`,`iv`.`Price` AS `Price`,`i`.`UOM` AS `UOM`,`iv`.`ImageFile` AS `ImageFile`,`l1`.`Name1` AS `Name1`,`l2`.`Name2` AS `Name2`,`l3`.`Name3` AS `Name3`,concat(`l1`.`Name1`,ifnull(concat(' / ',`l2`.`Name2`),''),ifnull(concat(' / ',`l3`.`Name3`),'')) AS `Category`,`l1`.`Level1No` AS `Level1No`,`l2`.`Level2No` AS `Level2No`,`l3`.`Level3No` AS `Level3No`,`i`.`ItemNo` AS `ItemNo`,`iv`.`VariantNo` AS `VariantNo`,`i`.`ItemFor` AS `ItemFor`,`iv`.`ItemNo` AS `ItemNoV`,`iv`.`VariantNameJSON` AS `VariantNameJSON`,(case when (`b`.`EndDate` < now()) then 'SOLD' when (`b`.`StartDate` > now()) then 'START' else 'PROGRESS' end) AS `BidStatus` from (((((((`itemvariant` `iv` join `item` `i` on((`iv`.`ItemNo` = `i`.`ItemNo`))) join `level1` `l1` on((`i`.`Level1No` = `l1`.`Level1No`))) left join `level2` `l2` on((`i`.`Level2No` = `l2`.`Level2No`))) left join `level3` `l3` on((`i`.`Level3No` = `l3`.`Level3No`))) join `biddingitems` `bi` on(((`iv`.`ItemNo` = `bi`.`ItemNumber`) and (`iv`.`VariantNo` = `bi`.`VariantNo`)))) join `bidding` `b` on((`b`.`BidCode` = `bi`.`BidCode`))) left join `vw_biduserscount` `bu` on((`bu`.`BidItemID` = `bi`.`ID`))) where ((`iv`.`Owned` = 1) and (`i`.`Owned` = 1) and (`iv`.`Price` is not null) and ((`i`.`SRemoved` = 0) or isnull(`i`.`SRemoved`)) and ((`iv`.`Removed` = 0) or isnull(`iv`.`Removed`)))) */;

/*View structure for view vw_biduserscount */

/*!50001 DROP TABLE IF EXISTS `vw_biduserscount` */;
/*!50001 DROP VIEW IF EXISTS `vw_biduserscount` */;

/*!50001 CREATE  VIEW `vw_biduserscount` AS (select `bi`.`ID` AS `BidItemID`,ifnull(concat(substr(`c`.`Firstname`,1,1),'.',`c`.`Lastname`),'-') AS `LastBidUser`,count(`bu`.`BidItemID`) AS `NoOfBidUsers`,max(`bu`.`CreatedDate`) AS `BidDate`,(`b`.`StartBidPrice` + (`b`.`BidPrice` * ifnull(count(`bu`.`BidItemID`),0))) AS `CurrentBidPrice`,(case when (`b`.`EndDate` < now()) then 'SOLD' when (`b`.`StartDate` > now()) then 'START' else 'PROGRESS' end) AS `BidStatus` from ((((`biddingitems` `bi` left join `biddingbyusers` `bu` on((`bi`.`ID` = `bu`.`BidItemID`))) left join `vw_lastbidusers` `bus` on((`bus`.`BidItemID` = `bu`.`BidItemID`))) left join `customer` `c` on((`c`.`CustomerNo` = `bus`.`CustomerNo`))) join `bidding` `b` on((`b`.`BidCode` = `bi`.`BidCode`))) group by `bu`.`BidItemID`) */;
...
/*View structure for view vw_lastbiduser */

/*!50001 DROP TABLE IF EXISTS `vw_lastbiduser` */;
/*!50001 DROP VIEW IF EXISTS `vw_lastbiduser` */;

/*!50001 CREATE  VIEW `vw_lastbiduser` AS (select `biddingbyusers`.`ID` AS `ID`,`biddingbyusers`.`BidItemID` AS `BidItemID`,`biddingbyusers`.`CustomerNo` AS `CustomerNo`,`biddingbyusers`.`CreatedDate` AS `CreatedDate` from `biddingbyusers` group by `biddingbyusers`.`CreatedDate` desc) */;

/*View structure for view vw_lastbidusers */

/*!50001 DROP TABLE IF EXISTS `vw_lastbidusers` */;
/*!50001 DROP VIEW IF EXISTS `vw_lastbidusers` */;

/*!50001 CREATE  VIEW `vw_lastbidusers` AS (select `vw_lastbiduser`.`ID` AS `ID`,`vw_lastbiduser`.`BidItemID` AS `BidItemID`,`vw_lastbiduser`.`CustomerNo` AS `CustomerNo`,`vw_lastbiduser`.`CreatedDate` AS `CreatedDate` from `vw_lastbiduser` group by `vw_lastbiduser`.`BidItemID`) */;
